...
(function() {
  ...
  sendVideoStart = function(callback) {
    var buf, e, error, payloadSize, streamNameBuf;
  ...
  h264.on('dts_nal_units', function(pts, dts, nalUnits) {
    var buf, concatNALUnit, e, error, i, isImportant, len, nalUnit, nalUnitType, nalUnitTypes, nalUnitsWithStartCode, payloadSize;
    isImportant = false;
    nalUnitTypes = [];
  ...
  aac.on('dts_adts_frames', function(pts, dts, adtsFrames) {
    var buf, concatADTSFrame, e, error, payloadSize;
